...
function login_auth(userid,pass,redirect){
	...
	request.open("get","ajax/validate.php?userid="+userid+"&password="+pass,true);
    request.send(null);
}
	...
	if((request.readyState==4)&& (request.status==200))
        {
            ...
            {
                window.location='profile.php?userid='+json.userid;
                request.onreadystatechange=myprofile;
                request.open("get","profile.php?userid="+json.userid,true);
                request.send(null);
            }
...
function getstreams()
{
        ...
        request3.open("get","ajax/getstreams1.php",true);
        request3.send(null);
...
function friendsstreams()
{
	...
	$(this).find('users').each(function(){
       ...
       $("#maincontainer").html(b.innerHTML);
            streamtimeout=setTimeout(function(){getstreams();},10000);
        }
}
...
{
    request.onreadystatechange=settheme;
    request.open("get","ajax/updatetheme.php?theme="+theme,true);
    request.send(null);
}
function settheme()
{
...
function createpage(pagename,category)
{

    request.onreadystatechange=function(){pagecreated(category);};
    request.open("get","ajax/createpage.php?type=default&pagename="+pagename+"&category="+category+"&subcategory="+category,true);
    alert("ajax/createpage.php?type=default&pagename="+pagename+"&category="+category+"&subcategory="+category);
    request.send(null);
