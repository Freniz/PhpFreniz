...
mysql_connect("localhost", "nizam", "ajith786") or die("cannot connect to mysql");
mysql_select_db("fztest1")or die("database no longer available");

$result=mysql_query("select id,infoid,name from places where id='".$_REQUEST['placeid']."'");
while($row=  mysql_fetch_assoc($result))
{
    $result1=mysql_query("select id,name,asciiname,latitude,longitude,country,province,timezone,featuredleafs from placesinfo where id='".$row['infoid']."'");
    while ($row1=  mysql_fetch_assoc($result1)){
        $result3=mysql_query("select provincename from province where provinceid='".$row1['country'].".".$row1['province']."'");
        $result4=mysql_query("select name from country where code='".$row1['country']."'");
        $province='';$country='';
...
<title>Freniz - <?php echo $row['name']; ?> </title>
...
<li><a href="leaf.php?leafid=<?php echo $_REQUEST['placeid']; ?>&tab=info" >Leaf Info</a></li>
