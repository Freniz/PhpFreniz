...
session_start();
if(isset($_SESSION['userid'])&& isset($_REQUEST['placeid']) &&  isset($_REQUEST['category']))
{
    ...
    $query="select pageid,pagename,pagepic,vote,type,category,subcategory,url,bids from pages where ";
    if(isset($_REQUEST['key']))
        $query.=" pagename like '".mysql_real_escape_string($_REQUEST['key'])."%' and ";
    $query.=" place='$infoid' and category='".$_REQUEST['category']."' order by bids desc limit 20";
